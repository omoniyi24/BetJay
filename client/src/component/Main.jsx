...
function Main() {
    ...
    return (
        <div className='container'>
            ...
            <Footer horses={horses}  handleDisplay={handleDisplay}  handleWalletBalance={handleWalletBalance} walletAmount={walletAmount} handleIsBetPlaced={handleIsBetPlaced}/>
        </div>
    );
